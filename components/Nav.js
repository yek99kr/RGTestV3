  ...
  return (
    <>
      <div className="fixed top-0 pt-[2.5vw] sm:pt-3 z-[1000] text-[2.9vw] sm:text-[15px] md:text-[16px] lg:text-[18px] xl:text-[18.5px] flex justify-center items-center w-screen select-none">
        <div className="flex justify-center items-center bg-white/60 backdrop-blur-md rounded m-0 mr-[1.5vw] sm:mr-3 w-[18vw] h-[7.9vw] sm:w-[6rem] sm:h-[2.35rem] md:w-[6.5rem] md:h-[2.4rem] lg:w-[7.5rem] lg:h-[2.6rem] select-none ">
          <Link href="/" passHref scroll={false}>
            <a className="thumbcursor">
              <img
                src="/logoShort.png"
                alt="logo"
                className="w-[13.2vw] sm:w-[70px] md:w-[76px] lg:w-[87.5px] xl:w-[93px] h-auto"
              />
            </a>
          </Link>
        </div>
        ...
        >
          <Link href="/work" passHref scroll={false}>
            <a
              className={`inline-block hover:rotate-[3deg]  p-[0.2vw] sm:p-0 sm:pl-0.5 sm:pr-1 thumbcursor duration-[0.2s]  hover:opacity-100
              ${
          ...
          <Link href="/contact" passHref scroll={false}>
            ...
            >
              <span className={`p-1.5  pr-[2vw] pl-[2.5vw] sm:pr-3 sm:pl-3  `}>
                Contact
              </span>
            </a>
          </Link>
