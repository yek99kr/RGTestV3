...
const ProductList = ({ products }) => {
  ...
  const classes = [
    // "md:mt-[2vw] md:rotate-[5deg] md:col-start-1 md:top-[4rem]",
    // "md:mt-[5vw] md:rotate-[-8deg] md:col-start-3 md:top-[5rem]",
    // "md:mt-[3vw] md:rotate-[-2deg] md:col-start-5 md:top-[4rem] ",
