...
const ProductList = ({ products }) => {
  ...
  const classes = [
    ...
    "md:mt-[2vw] md:rotate-[5deg] md:col-start-1 md:left-[20%] lg:left-[0%] md:top-[15%] lg:top-[15%] xl:top-[20%] 2xl:top-[6%] ",
    "md:mt-[5vw] md:rotate-[-8deg] md:col-start-3 md:top-[65%] lg:top-[45%] xl:top-[35%] 2xl:top-[20%]",
    "md:mt-[3vw] md:rotate-[-2deg] md:col-start-5 md:right-[20%] lg:left-[0%] md:top-[20%] lg:top-[20%] xl:top-[20%] 2xl:top-[10%] ",
  ...
  return (
    <div className="mx-auto py-10 px-5  sm:px-6 lg:px-0 sm:mt-[1rem] md:w-[90vw] lg:w-[80vw] xl:w-[75vw] md:h-[99vh]">
